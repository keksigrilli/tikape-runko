...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        get("/alueet/:id/:page", (req, res) -> { // Hakee alueeseen liittyvÃ¤t aiheet.
            HashMap map = new HashMap<>();
            map.put("alue", alueDao.findOne(Integer.parseInt(req.params("id"))));
            if (aiheDao.getAiheet(Integer.parseInt(req.params("id")),
                    Integer.parseInt(req.params("page"))).get(0).getNimi() == null) { // Jos ensimmäisen aiheen nimi on tyhjä, aiheita ei ole.
                ...
                map.put("aiheet", aiheDao.getAiheet(Integer.parseInt(req.params("id")),
                        Integer.parseInt(req.params("page"))));
            }

            int maxPage = aiheDao.maxPage(Integer.parseInt(req.params("id")));
        ...
        get("/alueet/:alueid/aihe/luo", (req, res) -> { // Hakee sivun jossa voi luoda uusia aiheita. TÃ„ssÃ¤ ei oikeastaan tapahdu mitÃ¤Ã¤n.
            HashMap map = new HashMap<>();
        ...
        post("/alueet/:alueid/aihe/luo", (req, res) -> { // Luo uuden aiheen valittuun alueeseen.
            HashMap map = new HashMap<>();
            ...
            res.redirect("/alueet/" + req.params("alueid") + "/1");
            return new ModelAndView(map, "luoAihe");
        }, new ThymeleafTemplateEngine());
